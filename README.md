...
## 📰 Task 2: Narrative Building from News Dataset
...
├── semantic_search/
│   └── postman-twitter-api/
│       └── Twitter API v2.postman_collection.json
├── models/                        # Generated by build_index.py
│   ├── faiss_index.bin
│   ├── chunks.json
│   ├── embeddings.npy
│   └── metadata.json
├── Dataset_for_second_task.json   # 81MB news dataset
├── documentation_chunks.json      # Generated by extract_and_chunk.py
├── extract_and_chunk.py           # Step 1: Extract documentation
├── build_index.py                 # Step 2: Build search index
├── semantic_search.py             # Task 1: Semantic search CLI
├── narrative_builder.py           # Task 2: Narrative builder CLI
├── requirements.txt
└── README.md
```
...
- ✅ **Intelligent Chunking**: 212 chunks across 6 types (endpoints, parameters, examples, etc.)
- ✅ **Semantic Embeddings**: sentence-transformers (all-MiniLM-L6-v2)
- ✅ **Fast Retrieval**: FAISS with cosine similarity
- ✅ **Rich Metadata**: Preserves category, method, URL for each chunk
- ✅ **JSON Output**: Clean, structured results

### Task 2: Narrative Building

- ✅ **Dynamic Topic Handling**: Works with ANY user-provided topic
- ✅ **Source Filtering**: Filters by source_rating > 8
- ✅ **Semantic Relevance**: Uses sentence embeddings for topic matching
- ✅ **AI Summary**: Generates narrative summary (with fallback)
- ✅ **Chronological Timeline**: Sorted events with context
- ✅ **Narrative Clustering**: Groups similar articles by theme
- ✅ **Relationship Graph**: Detects 4 types of inter-article relations
